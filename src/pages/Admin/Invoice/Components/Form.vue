          ...
          <VRow>
            ...
            <VCol cols="12" md="6">
              <VRow no-gutters>
                ...
                <VCol cols="12" md="9">
                  <VTextField :disabled="!!campDisabledAutomaticNumbering" v-model="formulario.number" clearable placeholder="Número" :error-messages="errors.number"
              ...
              <VTable>
                ...
                <tbody>
                  <tr v-for="(item,index) in arrayProducts" :key="index" v-show="item.delete != 'delete'">
                    ...
                    <td :style="{ width: '12%' }">
                      <VTextField :disabled="!item.product_id" clearable v-model="item.quantity" :error-messages="errorsArrayProduct[index]?.quantity" @keypress="errorsArrayProduct[index].quantity = '';soloNumeros($event)" />
                    </td>
                    <td :style="{ width: '12%' }">
