...
import { requiredValidator, lengthMaxValidator,emailValidator,soloNumeros } from '@validators';
                  ...
                  <VRow>
                    <VCol cols="12">
                      <VRow v-for="(item,index) in arrayPhone" :key="index" v-show="item.delete != 'delete'">
                          <VCol cols="3">
                              <VTextField v-model="item.indicative" maxlength="10" label="Indicativo" :error-messages="errorsArrayPhone[index]?.indicative" :rules="[requiredValidator]" @keypress="errorsArrayPhone[index].indicative = ''"/>
                          </VCol>
                          <VCol cols="4">
                              <VTextField v-model="item.phone" maxlength="10" label="# de Teléfono" :error-messages="errorsArrayPhone[index]?.phone" :rules="[requiredValidator]" @keypress="errorsArrayPhone[index].phone = '';soloNumeros($event)"/>
                          </VCol>
                          <VCol cols="4">
                              <VTextField v-model="item.extension" maxlength="10" label="Extensión" :error-messages="errorsArrayPhone[index]?.extension" :rules="[requiredValidator]" @keypress="errorsArrayPhone[index].extension = ''"/>
                          </VCol>
                          <VCol cols="1">
              ...
              <VCard class="mx-auto" >
                <VCardText>
                  ...
                  <VRow>
                    ...
                    <VCol cols="8">
                      <VTextField maxlength="50" label="# de telefono"  @keypress="soloNumeros($event)" v-model="formulario.phone_fac"/>
                    </VCol>
                  </VRow>
                  <VRow>
                    <VCol cols="12">
                  ...
                  <VRow>
                      ...
                      <VCol cols="12">
                          <VRow v-for="(item,index) in arrayContact" :key="index" v-show="item.delete != 'delete'">
                              ...
                              <VCol cols="2">
                                  <VTextField   v-model="item.phone" maxlength="10" label="# de Teléfono" :error-messages="errorsArrayContact[index]?.phone" :rules="[requiredValidator]" @keypress="errorsArrayContact[index].phone = '';soloNumeros($event)"/>
                              </VCol>
                              <VCol cols="1">
